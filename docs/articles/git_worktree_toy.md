...
To keep our architecture clean, we store all workflow components—agent
...
We use a factory function to dynamically resolve nodes. This factory
handles both standard LLM nodes and specialized nodes like the **Merge
Harmonizer**.
