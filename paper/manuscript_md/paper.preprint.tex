...
Researchers can use \texttt{HydraR} to design workflows as step-by-step pipelines (Directed Acyclic Graphs) or looping state machines, where each step can be an AI-driven task, a predictable R function, or an automated data auditor. \texttt{HydraR} ensures broad compatibility---connecting seamlessly to cloud AI engines (Gemini (\citeproc{ref-google2025gemini}{Google, 2025}), Claude, OpenAI) and local models (Ollama)---while enforcing reliability through a built-in validation engine that rigorously inspects the configuration for syntax and structural flaws prior to running.
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/itinerary_page_1.png}}
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio]{figures/itinerary_page_2.png}}
