...
To keep our architecture clean, we store complex R functions (like prompts and validation logic) in a central registry. This allows the Mermaid graph to focus on the structure and metadata.
