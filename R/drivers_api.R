...
OpenAIDriver <- R6::R6Class("OpenAIDriver",
  ...
  public = list(
    ...
    initialize = function(id = "openai_api", model = "gpt-4o", validation_mode = "warning") {
      super$initialize(id, provider = "openai", model_name = model, validation_mode = validation_mode)
...
AnthropicDriver <- R6::R6Class("AnthropicDriver",
  ...
  public = list(
    ...
    initialize = function(id = "anthropic_api", model = "claude-3-5-sonnet-20241022", validation_mode = "warning") {
...
GeminiAPIDriver <- R6::R6Class("GeminiAPIDriver",
  ...
  public = list(
    ...
    initialize = function(id = "gemini_api", model = "gemini-1.5-pro", validation_mode = "warning") {
