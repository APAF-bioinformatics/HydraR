...
#> merge). Use set_start_node() to disambiguate.
#> Graph compiled successfully.
#> [2026-04-05 09:39:18] [Worktree] Initializing WorktreeManager for thread: run-227c23b3
#> [2026-04-05 09:39:18] [Parallel] Executing 3 nodes in isolated worktrees using furrr...
...
#> Warning: package ‘purrr’ was built under R version 4.5.2
#> Warning: package ‘ggplot2’ was built under R version 4.5.2
#> [2026-04-05 09:40:04] [Parallel] Executing 1 nodes in isolated worktrees using furrr...
#>    [merger] Executing R logic...
#> [merger] Starting merge of 3 branches into main...
#>    [merger] Merging branch: hydra/run-227c23b3/bubble-cdf17921
#>    [merger] Merging branch: hydra/run-227c23b3/quick-e3f63443
#>    [merger] Merging branch: hydra/run-227c23b3/merge-d0a308b1
#> [2026-04-05 09:40:04] [Parallel] Executing 1 nodes in isolated worktrees using furrr...
#>    [benchmark] Executing R logic...
#> [Benchmark] Running on branch: hydra/run-227c23b3/benchmark-e5487a8e
#> [Benchmark] Found 3 algorithm files: bubble_sort.R, merge_sort.R, quick_sort.R
#> Warning in value[[3L]](cond): [Benchmark] Failed to source bubble_sort.R:
#> attempt to use zero-length variable name
#> Warning in value[[3L]](cond): [Benchmark] Failed to source merge_sort.R: merge_sort.R:18:1: unexpected '}'
#> 17:   return(merged_vec)
#> 18: }
#>     ^
#> Warning in value[[3L]](cond): [Benchmark] Failed to source quick_sort.R: quick_sort.R:19:1: unexpected '}'
#> 18:   c(quick_sort(less), equal, quick_sort(greater))
#> 19: }
#>     ^
#> [2026-04-05 09:40:04] [Parallel] Executing 1 nodes in isolated worktrees using furrr...
